VERSION 5.00
Begin VB.Form FRMSSTF 
   BackColor       =   &H00FF8080&
   Caption         =   "SSTF DISK SCHEDULING ALGORITHM IMPLEMENTATION USING VB"
   ClientHeight    =   9105
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11880
   ...
   Begin VB.Frame Frame3 
      ...
      Top             =   6000
      Width           =   1455
      Begin VB.CommandButton cmdSSTF 
         BackColor       =   &H0080FFFF&
         Caption         =   " &SSTF"
         BeginProperty Font 
   ...
   Begin VB.Frame Frame2 
      BackColor       =   &H00800000&
      Caption         =   "   NEW SSTF DISK SCHEDULING OUTPUT WINDOW   "
      BeginProperty Font 
...
If (create = True) Then
 ...
 PicSSTF.Print
  ...
  PicSSTF.Print "The Execution time is: "; CStr((GetTickCount - lngTime) / 1000); "secs."
