...
Begin VB.Form FRMLOOK 
   BackColor       =   &H8000000A&
   Caption         =   "LOOK DISK SCHEDULING ALGORITHM IMPLEMENTATION USING VB"
   ClientHeight    =   9735
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   11985
   ...
   Begin VB.Frame Frame2 
      BackColor       =   &H00800000&
      Caption         =   "   LOOK DISK SCHEDULING OUTPUT WINDOW"
      BeginProperty Font 
         Name            =   "Palatino Linotype"
         Size            =   9
         Charset         =   0
...
If (create = True) Then
 ...
 PicLOOK.Print
  ...
  PicLOOK.Print "The Execution time is: "; CStr((GetTickCount - lngTime) / 1000); "secs."
