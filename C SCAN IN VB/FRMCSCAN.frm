...
Begin VB.Form FRMCSCAN 
   ...
   Begin VB.Frame Frame3 
      ...
      Top             =   6720
      Width           =   1455
      Begin VB.CommandButton cmdCSCAN 
         BackColor       =   &H0080FFFF&
         Caption         =   " &C-SCAN"
         BeginProperty Font 
   ...
   Begin VB.Frame Frame2 
      BackColor       =   &H00800000&
      Caption         =   "   C-SCAN DISK SCHEDULING OUTPUT WINDOW"
      BeginProperty Font 
...
If (create = True) Then
 ...
 PicCScan.Cls
 PicCScan.Print "  This new (C-SCAN) list of all items entered "
 PicCScan.Print
  If n > 30 Then
   For i = 0 To 30
   PicCScan.Print T(i); Spc(2);
    Next i
    PicCScan.Print
    For i = 31 To n + 1
   PicCScan.Print T(i); Spc(2);
   ...
   PicCScan.Print T(i); Spc(2);
    Next i
    End If
  PicCScan.Print: PicCScan.Print
  PicCScan.Print "The Total Head Movement is: "; Count
  PicCScan.Print " The Average Seek Time is:  "; FormatNumber(ast, 2)
  PicCScan.Print "The Execution time is: "; CStr((GetTickCount - lngTime) / 1000); "secs."
...
cmdCSCAN.ToolTipText = "Make Sure you click start before you click me "
CmdStart.Enabled = True
CmdStart.TabIndex = 0
...
PicCScan.Left = HScroll1.Value * -1
PicCScan.Width = PicCScan.Width + HScroll1.Value
Call cmdCScan_Click
